...
import com.reactnativecommunity.webview.RNCWebViewManager.RNCWebView;
...
public class RNCWebViewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  ...
  @ReactMethod(isBlockingSynchronousMethod = true)
  public String toPdf(RNCWebView webView) {

   // RNCWebViewManager.RNCWebView rncw =  webView;
    return "hi";
//    PrintJob printJob;
...
//    PrintManager printManager = (PrintManager) getReactApplicationContext().getSystemService(Context.PRINT_SERVICE);
//
//
//    String jobName = "FreeSens_Report";
//
//    // Creating  PrintDocumentAdapter instance
   // PrintDocumentAdapter pda = ((RNCWebViewManager.RNCWebView) webView).getPrintAdapter();
//
