...
-(NSDictionary*)toPdf{
    ...
    CGRect paperRect = CGRectMake(0, 0, 600, 800);
    CGRect printableRect = CGRectMake(0, 0, 600, 800);
    
    
    [render setValue:[NSValue valueWithCGRect:paperRect] forKey:@"paperRect"];
    [render setValue:[NSValue valueWithCGRect:printableRect] forKey:@"printableRect"];
    
    NSData * pdfData = [render printToPDF:6 backgroundColor:UIColor.whiteColor ];
    NSString* _filePath = [NSString stringWithFormat:@"%@%@.pdf", NSTemporaryDirectory(), @"FreeSens_Report"];
    if (pdfData) {
        NSString *pdfBase64 = @"";
        ...
        NSDictionary *data = [NSDictionary dictionaryWithObjectsAndKeys:
                              pdfBase64, @"base64",
                              [NSString stringWithFormat: @"%ld", (long)6], @"numberOfPages",
